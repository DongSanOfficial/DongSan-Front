  ...
  const categories = [
    {
      title: '로그인',
      routes: [
        { route: '/signin', name: '소셜 로그인', headerShown: false },
      ]
    },
    {
      title: '메인',
      routes: [
        { route: '/main', name: '메인', headerShown: false },
      ]
    },
    {
      title: '산책로 등록',
    ...
    },
    {
      ...
      routes: [
        ...
        { route: '/mypage/TrailLikeList', name: '내가 좋아요한 산책로 전체 리스트' },
        { route: '/mypage/ReviewList', name: '내가 등록한 리뷰 리스트 보기' },
        { route: '/mypage/myregister', name: '내 산책로 상세 페이지 단건 조회' },
      ]
    },
    {
      title: '리뷰',
    ...
    },
    {
      ...
      routes: [
        ...
        { route: '/usingtrail/detail', name: '다른 유저가 등록한 산책로 상세 페이지' },
      ]
    }
  ];
